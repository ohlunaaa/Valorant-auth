...
class Auth:
    def __init__(self, username, password):
        ...
        self.session.headers = ({"User-Agent": "RiotClient/58.0.0    .4640299.4552318 %s (Windows;10;;Professional, x64)","Accept-Language": "en-US,en;q=0.9","Accept": "application/json, text/plain, */*"})
        ...
        self.base_headers = {'User-Agent': "RiotClient/58.0.0.4640299.4552318 rso-auth (Windows;10;;Professional, x64)",'Authorization': f'Bearer {self.access_token}',}
    ...
    def returning(self):
        return [self.access_token,self.id_token,self.entitlement,self.emailverifed,self.Sub,self.Name,self.Tag,self.creationdata,self.typeban,self.Region]
